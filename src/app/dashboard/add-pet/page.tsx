    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="mx-auto max-w-2xl space-y-6 rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
        <div className="space-y-2">
          ...
          <label
            htmlFor="image"
            className="flex h-48 w-full cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 transition-colors hover:border-[#f18912]/50 hover:bg-[#f18912]/5"
          >
            {form.imagePreview ? (
            ...
            {PET_TYPES.map((t) => (
              <button
                ...
                className={`flex flex-1 items-center justify-center gap-2 rounded-xl border-2 px-4 py-3 transition-all ${
                  form.type === t.value ? 'border-[#f18912] bg-[#f18912]/10 text-[#f18912]' : 'border-gray-200 bg-white text-gray-600 hover:border-gray-300'
                }`}
              >
                {t.label}
              </button>
        ...
        <div className="flex gap-3 pt-4">
          <Button type="submit" className="flex-1 bg-[#f18912] hover:bg-[#458559]">
            Хадгалах
          </Button>
