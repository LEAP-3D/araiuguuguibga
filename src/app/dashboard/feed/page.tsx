  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <Link href="/dashboard/add-post" className="mb-6 flex items-center gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:bg-gray-50">
        ...
        <div className="flex-1 rounded-full border border-gray-200 bg-gray-50 px-4 py-2.5 text-left text-gray-500 transition-colors hover:bg-gray-100">Юу бодож байна вэ? Олдсон амьтад оруулах...</div>
      </Link>
      {posts.length === 0 ? (
