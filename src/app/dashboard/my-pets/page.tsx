  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Таны бүртгэсэн амьтдын жагсаалт</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {myPets.map((pet) => (
          <Link
            ...
            className="group block cursor-pointer rounded-2xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:shadow-lg hover:border-[#f18912]/30"
          >
            ...
            {pet.age && <p className="mt-1 text-xs text-gray-500">{pet.age}</p>}
          </Link>
        ))}

        <Link
          href="/dashboard/add-pet"
          className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 p-6 transition-colors hover:border-[#f18912]/50 hover:bg-[#f18912]/5"
        >
      ...
      {myPets.length === 0 && <p className="mt-6 text-center text-sm text-gray-500">Амьтан бүртгээгүй байна. &quot;Амьтан нэмэх&quot; дээр дарж эхлээрэй.</p>}
    </div>
  );
}
