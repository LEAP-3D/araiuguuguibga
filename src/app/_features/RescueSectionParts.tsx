  ...
  return (
    <section id="adopt" className="min-h-[70vh] px-4 py-12">
      <div className="mb-8 text-center">
        ...
        <h2 className="mb-2 text-3xl font-bold text-gray-800">Хайр хайж буй амьтад</h2>
        <p className="text-gray-800">Эдгээр эвлүүлэг амьтад мөнхийн гэрийг хүлээж байна.</p>
      </div>
