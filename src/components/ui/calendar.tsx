...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        Root: ({ className: rootClassName, rootRef, ...rootProps }) => <div data-slot="calendar" ref={rootRef} className={cn(rootClassName)} {...rootProps} />,
        Chevron: ({ className: iconClassName, orientation, ...iconProps }) => {
          if (orientation === 'left') return <ChevronLeftIcon className={cn('size-4', iconClassName)} {...iconProps} />;
          if (orientation === 'right') return <ChevronRightIcon className={cn('size-4', iconClassName)} {...iconProps} />;
